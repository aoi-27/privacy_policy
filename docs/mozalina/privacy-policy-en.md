...
"mozalina" (hereinafter referred to as "the App") is a photo editing application that allows users to add face stamps to photos. This Privacy Policy explains how we handle personal information in the App.
...
- **Camera**: To take photos and add stamps
- **Photo Library (Read)**: To select existing photos and add stamps
...
The App uses Apple's Core Image framework (CIDetector) on-device to detect the location of faces within photos selected by the user, solely for the purpose of automatically positioning face stamps.
