...
"faded" (hereinafter referred to as "the App") is a photo editing application that allows users to apply filters, frames, and overlays to photos. This Privacy Policy explains how we handle personal information in the App.
...
- **Camera**: To take photos and add filters and frames
- **Photo Library (Read)**: To select existing photos and add filters and frames
...
- Support URL: [https://aoi-27.github.io/privacy_policy/faded/privacy-policy.html](https://aoi-27.github.io/privacy_policy/faded/privacy-policy.html)
